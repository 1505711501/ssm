...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							<select class=id="selectSize" onchange="javascript:toPage()" class="form-control">
	...
	<script>
        ...
        //跳转分页的方法
        function toPage() {
            //得到下拉框中被选择的值作为每页条数参数传递
            //jquery获取 $("#selectSize").val();
            //原始方式获取
            var pageSize = document.getElementById("selectSize").value;
            window.location.href="${pageContext.request.contextPath}/order/findAllOrder?pageSize="+pageSize;
        }
	</script>
</body>
